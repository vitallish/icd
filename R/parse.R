...
update_everything <- function() {
  ...
  icd9_parse_ahrq_ccs(single = TRUE, dx = TRUE, save_data = TRUE, offline = FALSE)
  icd9_parse_ahrq_ccs(single = FALSE, dx = TRUE, save_data = TRUE, offline = FALSE)
  icd9_parse_ahrq_ccs(single = FALSE, dx = FALSE, save_data = TRUE, offline = FALSE)
  icd9_parse_ahrq_ccs(single = TRUE, dx = FALSE, save_data = TRUE, offline = FALSE)
  icd10_parse_ahrq_ccs(version = "2018.1",dx = TRUE, save_data = TRUE, offline = FALSE)
  icd10_parse_ahrq_ccs(version = "2018.1",dx = FALSE, save_data = TRUE, offline = FALSE)
